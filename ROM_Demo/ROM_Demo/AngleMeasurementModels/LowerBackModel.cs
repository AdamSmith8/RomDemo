...
namespace ROM_Demo.AngleMeasurementModels {
	class LowerBackModel : AngleMeasurementModel {
		public LowerBackModel(int bitmapWidth, int bitmapHeight)
			: base(bitmapWidth, bitmapHeight) {
			
			TestName = "Lower Back";

			JointsToMeasure.Add(JointType.SpineMid);
			JointsToMeasure.Add(JointType.SpineBase);
			JointsToMeasure.Add(JointType.HipRight);
		}
